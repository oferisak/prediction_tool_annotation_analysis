...
- implemented posterior prob calculation. need to update it so that the get_density function supports inverted scores.
...
#time_var_set<-c('at_or_after_2021')
...
all_conservation_analysis_res<-calculate_roc_metrics(proc_data,data.frame(filter1=year_to_analyze,filter2='all_conservation'),tools_to_test,complete = F,save_rocs=F)
...
conservation_analysis_res_full<-calculate_roc_metrics(proc_data,analysis_var_sets,tools_to_test,complete = F,save_rocs = F,converted_scores=converted_scores,calculate_posterior_probs = T)
