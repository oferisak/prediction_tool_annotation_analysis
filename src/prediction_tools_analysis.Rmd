...
analysis_folder_name<-'./output/prediction_tools_analysis.2024-09-02'
```
...
# score thresholds calculations - should be performed using the full dataset (per tool)
...
conservation_score_thresholds%>%
  ...
  labs(x='Conservation',y='Score',color='Criteria')
conservation_score_thresholds_plot
...
moi_score_thresholds%>%
  ...
  facet_wrap(tool~.,scales='free_y')+
  theme_minimal()+theme(legend.position = 'top')+
  labs(x='Mode of Inheritance',y='Score',color='Criteria')
moi_score_thresholds_plot
